	...
	public function add_style_controls( $icon_controls = self::ICON_MANAGER, $condition = [], $override = [], $prefix = '', $selector_prefix = '', $section_label = ''  ) {
		...
		$fields = [
			...
			$prefix . 'button_icon_position' => [
				...
				'selectors'            => [
					'{{WRAPPER}} ' . $selector_prefix . '.box-button > span' => 'display: flex; align-items: center; justify-content: center; flex-flow: row nowrap;',
					...
					$prefix . 'tab_button_hover'  => [
						...
						'fields' => [
							$prefix . 'button_hover_color'        => [
								...
								'type'      => Controls_Manager::COLOR,
								'selectors' => [
									'{{WRAPPER}} ' . $selector_prefix . '.box-button { transition: all 0.3s ease;} {{WRAPPER}} ' . $selector_prefix . '.box-button.elementor-button:hover, {{WRAPPER}} ' . $selector_prefix . '.box-button.elementor-button:hover *, {{WRAPPER}} .box-hover:hover ' . $selector_prefix . '.box-button.elementor-button, {{WRAPPER}} .box-hover:hover ' . $selector_prefix . '.box-button.elementor-button *'             => 'color: {{VALUE}};',
							...
							$prefix . 'button_background_hover'   => [
								...
								'types'          => [ 'classic', 'gradient' ],
								'exclude'        => [ 'image' ],
								'selector'       => '{{WRAPPER}} ' . $selector_prefix . '.box-button { transition: all 0.3s ease;} {{WRAPPER}} ' . $selector_prefix . '.box-button.elementor-button:hover, {{WRAPPER}} .box-hover:hover ' . $selector_prefix . '.box-button.elementor-button',
								'fields_options' => [
									'background' => [
										'default' => 'classic',
									],
							...
							$prefix . 'button_hover_border_color' => [
								...
								'type'      => Controls_Manager::COLOR,
								'selectors' => [
									'{{WRAPPER}} ' . $selector_prefix . '.box-button { transition: all 0.3s ease;}  {{WRAPPER}} ' . $selector_prefix . '.box-button.elementor-button:hover, {{WRAPPER}} .box-hover:hover ' . $selector_prefix . '.box-button.elementor-button' => 'border-color: {{VALUE}};',
								],
								'condition' => [
									$prefix . 'button_border_border!' => '',
								],
							...
							$prefix . 'button_hover_shadow'       => [
								...
								'selector'     => '{{WRAPPER}} ' . $selector_prefix . '.box-button { transition: all 0.3s ease;}  {{WRAPPER}} ' . $selector_prefix . '.box-button:hover, {{WRAPPER}} .box-hover:hover ' . $selector_prefix . '.box-button',
								'control_type' => self::CONTROL_TYPE_GROUP,
							],
						],
					],
