...
class Settings_Advanced extends The7_Tab_Base {
	...
	private function add_general_section() {
		...
		$this->add_control( 'the7_advanced_normalize_resize_on_mobile', [
			'label'            => esc_html__( 'Normalize Resize Event On Mobiles', 'the7mk2' ),
			'type'             => Controls_Manager::SWITCHER,
			'default'          => of_get_option( 'advanced-normalize_resize_on_mobile' ),
			'description'      => esc_html__( 'Can improve scrolling performance on mobile devices', 'the7mk2' ),
			'return_value'     => '1',
			'empty_value'      => '0',
			'the7_save'        => true,
			'the7_option_name' => 'advanced-normalize_resize_on_mobile',
			'export'           => false,
		] );
