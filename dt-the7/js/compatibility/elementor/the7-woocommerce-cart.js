(function ($) {
    ...
    $.the7CartWidget = function (el) {
        ...
        let $wrapper = $widget.find('.the7-e-woo-cart-wrapper');
        const classes = {
        ...
        methods = {
            init: function () {
                ...
                $widget.vars.heightTimer = setInterval(methods.handleResize, 100);
                $widget.refresh();
            },
            bindEvents: function () {
            ...
            populateTemplate: function (e) {
                ...
                if ($contentFragment.length) {
                    ...
                    //use local fragment
                    $contentFragment = $wrapper.find('.' + classes.fragmentContent)
                }
                //populate cart status from template
                $wrapper.removeClass(classes.cartEmpty);
                if ($contentFragment.hasClass(classes.cartEmpty)) {
                    $wrapper.addClass(classes.cartEmpty);
                } else {
        ...
        $widget.delete = function () {
            ...
            clearInterval($widget.vars.heightTimer)
        };
